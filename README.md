...
```
cd existing_repo
git remote add origin https://gitlab.com/VarunKumarChandra/taf.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/VarunKumarChandra/taf/-/settings/integrations)
